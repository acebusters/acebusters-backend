...
TableManager.prototype.pay = function(tableAddr, ewt) {
  ...
  //if no
    ...
    return self.db.getHand(tableAddr, handId - 1).then(function(_prevHand) {
      ...
      if (self.contract.activeSeats(lineup)<2)
      ...
      if (!self.helper.isMyTurn({lineup: lineup, dealer: newDealer}, pos))
      ...
      deck = shuffle();
      lineup[pos].last = ewt;
      return self.db.putHand(tableAddr, receipt.values[0], lineup, newDealer, deck);
    })
  }).then(function(){
